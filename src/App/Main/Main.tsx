    ...
    <main className="main">
      <div className="app__adaptive-container">
        <div className="main__content">
            ...
            <p>While there is only two <a href="https://gitlab.com/Do-While-For-Each/frontend" target="_blank" rel="noopener noreferrer">frontend implementation</a> and it is made on React. You are now interacting with this implementation.</p>
            <p>--</p>
